...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        Formerly a Quality Assurance Specialist at Ensemble Systems for 2+
        years. During my time there, I wore many hats working as a QA Tester,
        Technical Writer and QA Lead. These roles taught me the skills to think
